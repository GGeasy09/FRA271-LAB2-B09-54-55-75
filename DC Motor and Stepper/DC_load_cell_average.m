...
[PWM50,  stall_torque50]  = process_and_bin(squeeze(d50_1.simout1.signals.values),  squeeze(d50_2.simout1.signals.values),  squeeze(d50_3.simout1.signals.values),  d50_1.tout);
[PWM500, stall_torque500] = process_and_bin(squeeze(d500_1.simout1.signals.values), squeeze(d500_2.simout1.signals.values), squeeze(d500_3.simout1.signals.values), d500_1.tout);
[PWM1k,  stall_torque1k]  = process_and_bin(squeeze(d1k_1.simout1.signals.values),  squeeze(d1k_2.simout1.signals.values),  squeeze(d1k_3.simout1.signals.values),  d1k_1.tout);
[PWM10k, stall_torque10k] = process_and_bin(squeeze(d10k_1.simout1.signals.values), squeeze(d10k_2.simout1.signals.values), squeeze(d10k_3.simout1.signals.values), d10k_1.tout);
